...
This Python module provides functions for compressing and decompressing shape files. Both Windows, Linux and macOS are supported as this Python module is powered by the `TK.MSTS.Tokens.dll` library from Okrasa Ghia.
