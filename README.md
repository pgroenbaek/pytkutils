...
This Python module wraps the `TK.MSTS.Tokens.dll` library by Okrasa Ghia. The module allows you to compress and decompress MSTS files such as shapes and world files.
